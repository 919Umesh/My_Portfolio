            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(certificateList[index].organization,style: const TextStyle(color: linear1),),
                    Text(certificateList[index].date,style: const TextStyle(color:linear2,fontSize: 12),),
                  ],
                ),
